...
\restrict CkG1hYTgexA66grhOcb9Bx4BOndqTnDgsQSgLtXjVWsBfbl7qJyR8BvvEMyg4xk
...
ALTER TABLE IF EXISTS ONLY public.y_characters DROP CONSTRAINT IF EXISTS y_characters_job_id_fkey;
ALTER TABLE IF EXISTS ONLY public.y_character_items DROP CONSTRAINT IF EXISTS y_character_items_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.y_character_items DROP CONSTRAINT IF EXISTS y_character_items_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_guilds DROP CONSTRAINT IF EXISTS x_guilds_owner_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_guild_characters DROP CONSTRAINT IF EXISTS x_guild_characters_guild_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_guild_characters DROP CONSTRAINT IF EXISTS x_guild_characters_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_gold_transfers DROP CONSTRAINT IF EXISTS x_gold_transfers_to_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_gold_transfers DROP CONSTRAINT IF EXISTS x_gold_transfers_from_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_characters DROP CONSTRAINT IF EXISTS x_characters_job_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_character_items DROP CONSTRAINT IF EXISTS x_character_items_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.x_character_items DROP CONSTRAINT IF EXISTS x_character_items_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.n_characters DROP CONSTRAINT IF EXISTS n_characters_job_id_fkey;
ALTER TABLE IF EXISTS ONLY public.n_character_items DROP CONSTRAINT IF EXISTS n_character_items_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.n_character_items DROP CONSTRAINT IF EXISTS n_character_items_character_id_fkey;
ALTER TABLE IF EXISTS ONLY public.y_jobs DROP CONSTRAINT IF EXISTS y_jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.y_jobs DROP CONSTRAINT IF EXISTS y_jobs_name_key;
ALTER TABLE IF EXISTS ONLY public.y_items DROP CONSTRAINT IF EXISTS y_items_pkey;
ALTER TABLE IF EXISTS ONLY public.y_items DROP CONSTRAINT IF EXISTS y_items_name_key;
ALTER TABLE IF EXISTS ONLY public.y_characters DROP CONSTRAINT IF EXISTS y_characters_pkey;
ALTER TABLE IF EXISTS ONLY public.y_character_items DROP CONSTRAINT IF EXISTS y_character_items_pkey;
ALTER TABLE IF EXISTS ONLY public.x_jobs DROP CONSTRAINT IF EXISTS x_jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.x_jobs DROP CONSTRAINT IF EXISTS x_jobs_name_key;
ALTER TABLE IF EXISTS ONLY public.x_items DROP CONSTRAINT IF EXISTS x_items_pkey;
ALTER TABLE IF EXISTS ONLY public.x_items DROP CONSTRAINT IF EXISTS x_items_name_key;
ALTER TABLE IF EXISTS ONLY public.x_guilds DROP CONSTRAINT IF EXISTS x_guilds_pkey;
ALTER TABLE IF EXISTS ONLY public.x_guilds DROP CONSTRAINT IF EXISTS x_guilds_name_key;
ALTER TABLE IF EXISTS ONLY public.x_guild_characters DROP CONSTRAINT IF EXISTS x_guild_characters_pkey;
ALTER TABLE IF EXISTS ONLY public.x_gold_transfers DROP CONSTRAINT IF EXISTS x_gold_transfers_pkey;
ALTER TABLE IF EXISTS ONLY public.x_characters DROP CONSTRAINT IF EXISTS x_characters_pkey;
ALTER TABLE IF EXISTS ONLY public.x_character_items DROP CONSTRAINT IF EXISTS x_character_items_pkey;
ALTER TABLE IF EXISTS ONLY public.s_users DROP CONSTRAINT IF EXISTS s_users_pkey;
ALTER TABLE IF EXISTS ONLY public.s_characters DROP CONSTRAINT IF EXISTS s_characters_pkey;
ALTER TABLE IF EXISTS ONLY public.n_jobs DROP CONSTRAINT IF EXISTS n_jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.n_jobs DROP CONSTRAINT IF EXISTS n_jobs_name_key;
ALTER TABLE IF EXISTS ONLY public.n_items DROP CONSTRAINT IF EXISTS n_items_pkey;
ALTER TABLE IF EXISTS ONLY public.n_items DROP CONSTRAINT IF EXISTS n_items_name_key;
ALTER TABLE IF EXISTS ONLY public.n_characters DROP CONSTRAINT IF EXISTS n_characters_pkey;
ALTER TABLE IF EXISTS ONLY public.n_character_items DROP CONSTRAINT IF EXISTS n_character_items_pkey;
DROP TABLE IF EXISTS public.y_jobs;
DROP TABLE IF EXISTS public.y_items;
DROP TABLE IF EXISTS public.y_characters;
DROP TABLE IF EXISTS public.y_character_items;
DROP TABLE IF EXISTS public.x_jobs;
DROP TABLE IF EXISTS public.x_items;
DROP TABLE IF EXISTS public.x_guilds;
DROP TABLE IF EXISTS public.x_guild_characters;
DROP TABLE IF EXISTS public.x_gold_transfers;
DROP TABLE IF EXISTS public.x_characters;
DROP TABLE IF EXISTS public.x_character_items;
DROP TABLE IF EXISTS public.s_users;
DROP TABLE IF EXISTS public.s_characters;
DROP TABLE IF EXISTS public.n_jobs;
DROP TABLE IF EXISTS public.n_items;
DROP TABLE IF EXISTS public.n_characters;
DROP TABLE IF EXISTS public.n_character_items;
...
4c5707b6-95b3-4311-8c2c-a95a1416baa6	\N	1	1000	2020-09-23 13:37:00
8787fe85-f527-445d-991f-cdf61ee81853	\N	2	1000	2020-10-25 21:17:00
f5f7fb93-e139-4772-9e11-d96f828945b5	\N	3	1000	2020-12-05 10:20:00
866d146e-35b9-469c-8196-46522a2c0d69	\N	4	1000	2020-12-05 18:45:00
d2bb03f2-cfea-4df0-808d-8c9bcf08aef9	\N	5	1000	2021-02-15 09:10:00
df83bb70-2f2b-49fc-9615-70f2fbba867b	\N	6	1000	2021-06-14 14:25:00
8bfd771c-fac7-4c62-91e6-04b2de5ff592	\N	7	1000	2021-11-28 19:15:00
d731cdaf-951d-4516-a0af-43905d4c8643	\N	8	1000	2022-03-22 11:50:00
b57f2cf7-ac41-4363-a470-39766a27ce10	\N	10	1000	2022-11-10 16:35:00
1f03f4c2-c7b6-4a8b-a634-f1e110f5f3e7	\N	11	1000	2022-08-30 21:00:00
dda37688-de69-4738-9d5d-98586f3d5f7a	\N	12	1000	2023-01-19 15:13:00
528ffda5-9605-446b-80ac-119836ce321f	\N	13	1000	2023-02-02 18:55:00
d2c8d717-6b51-46d9-9141-2820e44cd324	\N	14	1000	2023-09-07 10:22:00
e49aef30-09e1-4268-953b-a582836a0f02	\N	16	1000	2024-01-27 09:19:00
69fdcf6f-e24d-4496-815b-0385766f948c	\N	17	1000	2024-03-18 11:01:00
dc18a2b8-116f-47a8-b963-b956a42d29b8	\N	18	1000	2024-05-11 11:47:00
6abaac0d-30f9-468e-80e5-6133bd2bf4e3	\N	19	1000	2024-07-12 15:48:00
7b0670c4-8959-44b2-ad52-3f5a402734a8	\N	9	1000	2022-04-06 22:15:00
0dcfe85f-2b33-4297-acf2-3ef8e2b1e0f1	\N	15	1000	2023-10-04 17:25:00
\.
...
2	High Potion	700	0.2	単体HPを中回復
3	Mega Potion	1350	0.3	単体HPを大回復
4	Giga Potion	3900	0.3	単体HPを完全回復
6	High Mana Potion	5150	0.2	単体MPを大回復
8	Paralyze Cure	500	0.1	麻痺状態を回復
9	Angel Feather	1400	0.1	戦闘不能を回復
12	Climbing Rope	1050	1.5	崖や段差を乗り越える
1	Potion	390	0.2	単体HPを小回復
5	Mana Potion	1350	0.1	単体MPを小回復
7	Antidote	560	0.1	毒状態を回復
10	Chimera Wing	850	0.1	指定の街に瞬間移動
11	Torch	1190	1.5	洞窟内を明るく照らす
\.
...
\unrestrict CkG1hYTgexA66grhOcb9Bx4BOndqTnDgsQSgLtXjVWsBfbl7qJyR8BvvEMyg4xk
